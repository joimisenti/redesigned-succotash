...
//         try {
//             // Loop through received data and store it in database
//             for (const { day, month, year, color, colorLabelId } of calendarData) {
...
//                 if (existingDay) {
//                     // Update existing record with new color
//                     existingDay.color = color;
//                     await existingDay.save();
//                 } else {
//                     // Create new record
//                     await DayWithColor.create({day, month, year, color, colorLabelId});
//                 }
//             }
...
//     getDayWithColor: async (req, res) => {
//         try {
//             const savedDaysWithColor = await DayWithColor.findAll();
